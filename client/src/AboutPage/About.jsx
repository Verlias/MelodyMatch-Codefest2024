        ...
        <>
            ...
            <section className={styles.AboutSection}>
                ...
                <div className={styles.AboutContent}>
                    ...
                    <div className={styles.GitHubLink}><a  href="https://github.com/Verlias/Financy" target="_blank" class="github"> < svg  className={styles.GitHubLink} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" class="bi bi-github" viewBox="0 0 16 16">
